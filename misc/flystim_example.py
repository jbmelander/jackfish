...
def main():
    left_screen = Screen(subscreens=[get_subscreen('l')], server_number=0, id=0, fullscreen=True, vsync=False, square_size=(0.1, 0.1), square_loc=(1, -1), name='Left', horizontal_flip=False)

    right_screen = Screen(subscreens=[get_subscreen('r')], server_number=0, id=1, fullscreen=True, vsync=False, square_size=(0.1, 0.122), square_loc=(-1, -1), name='Right', horizontal_flip=False)
